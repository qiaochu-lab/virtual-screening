...
run DrugCLIP $B/ckpt/drugclip/checkpoint_best.pt      $B/results/t3_raw/drugclip          0 drugclip
sleep 5
run BindCLIP $B/ckpt/bindclip/BindCLIP_randneg.pt     $B/results/t3_raw/bindclip_randneg  1 bindclip_randneg
sleep 5
run BindCLIP $B/ckpt/bindclip/BindCLIP_hardneg.pt     $B/results/t3_raw/bindclip_hardneg  2 bindclip_hardneg
disown -a
